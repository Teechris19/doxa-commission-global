...
use App\Models\{AppointmentReport, Appointment, Chapter};
...
new #[Layout('components.layouts.admin')] class extends Component {
    ...
    public function getReports()
    {
        ...
        return AppointmentReport::with(['appointment', 'team', 'chapter', 'user'])
    ...
    {
        AppointmentReport::findOrFail($id)->delete();
        $this->toast()->success('Deleted', 'Appointment report deleted')->send();
    }
}; ?>
...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold">Appointment Reports</h1>
            <p class="text-zinc-600 dark:text-zinc-400">Manage appointment reports and analytics</p>
        </div>
    </div>
