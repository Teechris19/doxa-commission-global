                ...
                <div class="p-6">
                    ...
                    <div class="space-y-2 mb-4">
                        ...
                        <div class="flex items-center text-sm text-zinc-700 dark:text-zinc-300">
                            ...
                            <span>{{ $cell->active_members_count }} / {{ $cell->max_members }} members</span>
                            @if($cell->isFull())
                                <span class="ml-2 text-xs text-red-600 font-semibold">(Full)</span>
                            @endif
                        </div>

                        <div class="w-full bg-zinc-200 dark:bg-zinc-700 rounded-full h-2">
                            <div class="bg-blue-600 h-2 rounded-full" style="width: {{ ($cell->active_members_count / $cell->max_members) * 100 }}%"></div>
                        </div>
                    </div>
