        ...
        <div class="mx-auto grid w-full max-w-7xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-4 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-4 text-lg">
                    @if (!empty($footerSocial['facebook']))
                        <a href="{{ $footerSocial['facebook'] }}" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="text-blue-100 transition hover:text-white"><i class="fab fa-facebook-f"></i></a>
                    @endif
                    @if (!empty($footerSocial['instagram']))
                        <a href="{{ $footerSocial['instagram'] }}" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="text-blue-100 transition hover:text-white"><i class="fab fa-instagram"></i></a>
                    @endif
                    @if (!empty($footerSocial['youtube']))
                        <a href="{{ $footerSocial['youtube'] }}" target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="text-blue-100 transition hover:text-white"><i class="fab fa-youtube"></i></a>
                    @endif
                    @if (!empty($footerSocial['tiktok']))
                        <a href="{{ $footerSocial['tiktok'] }}" target="_blank" rel="noopener noreferrer" aria-label="TikTok" class="text-blue-100 transition hover:text-white"><i class="fab fa-tiktok"></i></a>
                    @endif
                </div>
            </div>
        </div>
